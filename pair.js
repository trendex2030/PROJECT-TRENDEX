...
async function uploadCredsToMega(credsPath) {
    try {
        const storage = await new Storage({
            email: 'Babademmy13@gmail.com', // Your Mega A/c Email Here
            password: 'Babademmy001pass' // Your Mega A/c Password Here
        }).ready;
            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'TREND-X~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
💡 *Whats Next?* 
1️⃣ Explore all the cool features of TREND-X.
...
⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [trendex GitHub Repo](https://github.com/trendex2030/)  

🚀 _Thanks for choosing TREND-X Let the automation begin!_ ✨`;
